                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @foreach ($product->orderItems->where('rstatus',1) as $item)
                                @php
                                    $avgrating = $avgrating + $item->review->rating;
                                @endphp
                            @endforeach
                            @for($i = 1; $i<=5;$i++)
                                @if ($i <= $avgrating)
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="{{ route('product.details', ['slug'=>$product->slug]) }}"><img src="{{ asset('assets/images/social-list.png') }}" alt="{{ $product->name}}"></a>
                        </div>
                                            ...
                                            @foreach ($product->orderItems->where('rstatus',1) as $item)
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                    <div id="comment-20" class="comment_container"> 
                                                        <img alt="{{$item->order->user->name}}" src="{{ asset('assets/images/profile') }}/{{$item->order->user->profile->image}}" height="80" width="80">
