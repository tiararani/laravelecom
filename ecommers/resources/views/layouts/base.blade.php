...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/logors.png')}}">
...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="Contact Message" href="{{route('admin.contact')}}">Contact Messages</a>
													</li>
													<li class="menu-item">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/logors.png')}}" alt="mercado"></a>
						</div>
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.2/js/bootstrap.esm.min.js" integrity="sha512-6p8seCRNe8cAPBwjlr7uqqu4AYRpJMUSFUOnvIqZlLXekFHkx3tM7qNHR7nu4TJrpE7+mJMmOCKjNeMmlP6AVQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
	...
	<script src="https://cdn.tiny.cloud/1/e7eequl85jb8od6z6fj5iwqt517fxqxaypeiivkfjfh1maw0/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
